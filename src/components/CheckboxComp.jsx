...
<div className="text-sm  mb-5">Services</div>    
<div className="grid grid-flow-row gap-5 grid-cols-12">
<div className="col-span-6 lg:col-span-3 flex items-center space-x-1">
...
<div className="col-span-6 lg:col-span-3 lg:-ml-4 flex items-center space-x-1">
      <Checkbox className='border-white border-2 rounded-sm' id="terms" />
      <label
        htmlFor="terms"
        className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
